...
CvCapture* get_capture_webcam(int index) {
    ...
    try {
        ...
        ((cv::VideoCapture*)cap)->set(CV_CAP_PROP_BRIGHTNESS,-4);//liang du
        ((cv::VideoCapture*)cap)->set(CV_CAP_PROP_CONTRAST,40);//dui bi du
        ((cv::VideoCapture*)cap)->set(CV_CAP_PROP_SATURATION,20);//bao he du
        ((cv::VideoCapture*)cap)->set(CV_CAP_PROP_EXPOSURE,-2);//bao guang du*/
    }
    catch (...) {
