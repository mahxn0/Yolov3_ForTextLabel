...
net = load_net("/home/mahxn0/darknet/yolo_robot/robot.cfg", "/home/mahxn0/darknet/yolo_robot/robot_final_all.weights", 0)
meta = load_meta("/home/mahxn0/darknet/yolo_robot/robot.data")
...
#video ='rtspsrc location=rtsp://admin:123qweasd@192.168.1.64:554/h264/ch1/main/av_stream latency=0 ! rtph264depay ! h264parse ! omxh264dec ! nvvidconv ! video/x-raw, width=(int)1920, height=(int)1080, format=(string)BGRx ! videoconvert ! appsink'
#video="rtsp://admin:123qweasd@192.168.1.64:554/h264/ch1/main/av_stream"
video="/media/mahxn0/DATA/dataset/1.mp4"
...
#    #cap.open('rtsp://admin:123qweasd@192.168.0.222:554/h264/ch1/main/av_stream')
    ...
    while(cap.isOpened()):
        ...
        frame_res=frame[0:1080,600:1320]
