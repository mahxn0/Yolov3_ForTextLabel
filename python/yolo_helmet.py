...
net = load_net("/media/zdyd/code/yuanfei/object_detection/darknet_industry/yolo_act_final/yolov3.cfg", "/media/zdyd/code/yuanfei/object_detection/darknet_industry/yolo_act/yolov3_final.weights", 0)
meta = load_meta("/media/zdyd/code/yuanfei/object_detection/darknet_industry/yolo_act_final/act.data")
