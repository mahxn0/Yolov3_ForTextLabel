...
net = load_net("/home/mahxn0/darknet/yolo_box/box.cfg", "/home/mahxn0/darknet/yolo_box/box.weights", 0)
...
if __name__ == "__main__":
    ...
    picDir = '/home/mahxn0/darknet/image/box'
    print("path:",picDir)
    ...
    for name in filenames:
        ...
        for res in out:
            ...
            if y1-100>0:
                y1=y1-100
            frame_rect=image[(y1-10):(y2+50),(x1-80):(x2+80)]
            #cv2.imwrite('/home/mahxn0/darknet/image/box_rect1/'+str(i)+'.jpg',frame_rect)
        i+=1
