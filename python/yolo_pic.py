...
net = load_net("/home/mahxn0/darknet/tiny_watch/yolov3-tiny.cfg", "/home/mahxn0/darknet/tiny_watch/backup/yolov3-tiny_final.weights", 0)
meta = load_meta("/home/mahxn0/darknet/tiny_watch/watch.data")
...
if __name__ == "__main__":
    ...
    picDir = '/media/mahxn0/DATA/data/record/test_pic'
    print("path:",picDir)
    ...
    for name in filenames:
        ...
        if out==[]:
            y+=1
            f=open('/media/mahxn0/DATA/data/record/result.txt\n','a')
            f.write(filename)
        for res in out:
            x1=r.getXY(res[2])
            y1=r.getXY(res[3])
        ...
        cv2.imwrite('/media/mahxn0/DATA/data/record/test_record/'+str(i)+'.jpg',frame_res)
        i+=1
        print((i-y)/i)
